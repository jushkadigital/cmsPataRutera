import { convertLexicalNodesToHTML, HTMLConverter, SerializedListItemNode } from "@payloadcms/richtext-lexical"
import { ListItemNode, ListNode, SerializedListNode } from "@payloadcms/richtext-lexical/lexical/list"
...
export const ListItemHTMLConverter: HTMLConverter<SerializedListItemNode> = {
    converter: async ({
        ...
        if ('listType' in parent && parent?.listType === 'check') {
            ...
            return `<li aria-checked=${node.checked ? 'true' : 'false'} class="${'list-item-checkbox' +
