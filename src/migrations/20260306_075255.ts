...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "tours" ADD COLUMN "form_id" integer;
  ALTER TABLE "_tours_v" ADD COLUMN "version_form_id" integer;
  ALTER TABLE "paquetes" ADD COLUMN "form_id" integer;
  ALTER TABLE "_paquetes_v" ADD COLUMN "version_form_id" integer;
  ...
  DO $$ BEGIN
   ALTER TABLE "forms_rels" ADD CONSTRAINT "forms_rels_tours_fk" FOREIGN KEY ("tours_id") REFERENCES "public"."tours"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "forms_rels" ADD CONSTRAINT "forms_rels_paquetes_fk" FOREIGN KEY ("paquetes_id") REFERENCES "public"."paquetes"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "forms_rels_tours_id_idx" ON "forms_rels" USING btree ("tours_id");
  CREATE INDEX IF NOT EXISTS "forms_rels_paquetes_id_idx" ON "forms_rels" USING btree ("paquetes_id");
  ...
  DO $$ BEGIN
   ALTER TABLE "tours" ADD CONSTRAINT "tours_form_id_forms_id_fk" FOREIGN KEY ("form_id") REFERENCES "public"."forms"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_tours_v" ADD CONSTRAINT "_tours_v_version_form_id_forms_id_fk" FOREIGN KEY ("version_form_id") REFERENCES "public"."forms"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "paquetes" ADD CONSTRAINT "paquetes_form_id_forms_id_fk" FOREIGN KEY ("form_id") REFERENCES "public"."forms"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_paquetes_v" ADD CONSTRAINT "_paquetes_v_version_form_id_forms_id_fk" FOREIGN KEY ("version_form_id") REFERENCES "public"."forms"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "tours_form_idx" ON "tours" USING btree ("form_id");
  CREATE INDEX IF NOT EXISTS "_tours_v_version_version_form_idx" ON "_tours_v" USING btree ("version_form_id");
  CREATE INDEX IF NOT EXISTS "paquetes_form_idx" ON "paquetes" USING btree ("form_id");
  CREATE INDEX IF NOT EXISTS "_paquetes_v_version_version_form_idx" ON "_paquetes_v" USING btree ("version_form_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  ALTER TABLE "tours" DROP CONSTRAINT "tours_form_id_forms_id_fk";
  
  ALTER TABLE "_tours_v" DROP CONSTRAINT "_tours_v_version_form_id_forms_id_fk";
  
  ALTER TABLE "paquetes" DROP CONSTRAINT "paquetes_form_id_forms_id_fk";
  
  ALTER TABLE "_paquetes_v" DROP CONSTRAINT "_paquetes_v_version_form_id_forms_id_fk";
  ...
  DROP INDEX IF EXISTS "tours_form_idx";
  DROP INDEX IF EXISTS "_tours_v_version_version_form_idx";
  DROP INDEX IF EXISTS "paquetes_form_idx";
  DROP INDEX IF EXISTS "_paquetes_v_version_version_form_idx";
  ...
  ALTER TABLE "tours" DROP COLUMN IF EXISTS "form_id";
  ALTER TABLE "_tours_v" DROP COLUMN IF EXISTS "version_form_id";
  ALTER TABLE "paquetes" DROP COLUMN IF EXISTS "form_id";
  ALTER TABLE "_paquetes_v" DROP COLUMN IF EXISTS "version_form_id";
