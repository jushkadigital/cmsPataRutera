...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  await db.execute(sql`
   ALTER TABLE "tours_blocks_svticket" ADD COLUMN "price" numeric;
  ALTER TABLE "tours_blocks_svticket" ADD COLUMN "time" numeric;
  ALTER TABLE "_tours_v_blocks_svticket" ADD COLUMN "price" numeric;
  ALTER TABLE "_tours_v_blocks_svticket" ADD COLUMN "time" numeric;`)
}
