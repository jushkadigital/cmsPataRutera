...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_tours_blocks_text_content_description_alignment" AS ENUM('left', 'center', 'right');
  ...
  CREATE TYPE "public"."enum__tours_v_blocks_text_content_description_alignment" AS ENUM('left', 'center', 'right');
