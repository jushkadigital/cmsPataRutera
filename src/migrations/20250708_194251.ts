...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_ofertas_type_grid" AS ENUM('masonry', 'overlapping', 'list', 'mosaic', 'grid');
  ...
  CREATE TYPE "public"."enum_pages_blocks_text_content_description_alignment" AS ENUM('left', 'center', 'right', 'justify');
  ...
  CREATE TYPE "public"."enum_pages_blocks_grid_blogs_general_style" AS ENUM('masonry', 'grid');
  CREATE TYPE "public"."enum_pages_blocks_grid_blogs_populate_by" AS ENUM('collection', 'selection');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_ofertas_type_grid" AS ENUM('masonry', 'overlapping', 'list', 'mosaic', 'grid');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_text_content_description_alignment" AS ENUM('left', 'center', 'right', 'justify');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_grid_blogs_general_style" AS ENUM('masonry', 'grid');
  CREATE TYPE "public"."enum__pages_v_blocks_grid_blogs_populate_by" AS ENUM('collection', 'selection');
  ...
  CREATE TYPE "public"."enum_tours_blocks_grid_blogs_general_style" AS ENUM('masonry', 'grid');
  ...
  CREATE TYPE "public"."enum__tours_v_blocks_grid_blogs_general_style" AS ENUM('masonry', 'grid');
  ...
  CREATE TYPE "public"."enum_posts_blocks_grid_blogs_general_style" AS ENUM('masonry', 'grid');
  CREATE TYPE "public"."enum_posts_blocks_grid_blogs_populate_by" AS ENUM('collection', 'selection');
  CREATE TYPE "public"."enum_posts_blocks_grid_images_type_grid" AS ENUM('masonry', 'overlapping', 'list', 'mosaic', 'grid');
  ...
  CREATE TYPE "public"."enum_posts_blocks_text_content_description_alignment" AS ENUM('left', 'center', 'right', 'justify');
  ...
  CREATE TYPE "public"."enum__posts_v_blocks_grid_blogs_general_style" AS ENUM('masonry', 'grid');
  CREATE TYPE "public"."enum__posts_v_blocks_grid_blogs_populate_by" AS ENUM('collection', 'selection');
  CREATE TYPE "public"."enum__posts_v_blocks_grid_images_type_grid" AS ENUM('masonry', 'overlapping', 'list', 'mosaic', 'grid');
  ...
  CREATE TYPE "public"."enum__posts_v_blocks_text_content_description_alignment" AS ENUM('left', 'center', 'right', 'justify');
  ...
  CREATE TYPE "public"."enum_paquetes_blocks_grid_blogs_general_style" AS ENUM('masonry', 'grid');
  CREATE TYPE "public"."enum_paquetes_blocks_grid_blogs_populate_by" AS ENUM('collection', 'selection');
  ...
  CREATE TYPE "public"."enum_paquetes_blocks_text_content_description_alignment" AS ENUM('left', 'center', 'right', 'justify');
  ...
  CREATE TYPE "public"."enum__paquetes_v_blocks_grid_blogs_general_style" AS ENUM('masonry', 'grid');
  CREATE TYPE "public"."enum__paquetes_v_blocks_grid_blogs_populate_by" AS ENUM('collection', 'selection');
  ...
  CREATE TYPE "public"."enum__paquetes_v_blocks_text_content_description_alignment" AS ENUM('left', 'center', 'right', 'justify');
  ...
  CREATE TYPE "public"."enum_footer_nav_items_links_link_type" AS ENUM('reference', 'custom', 'text');
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_ofertas" (
  	...
  	"type_grid" "enum_pages_blocks_ofertas_type_grid" DEFAULT 'grid',
  	"block_name" varchar
  );
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_form_bitrix_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_revista_block_revistas_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"image_id" integer,
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_revista_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"block_title_title_text" varchar,
  	"block_title_tag" "enum_pages_blocks_revista_block_block_title_tag" DEFAULT 'h2',
  	"block_title_size" "enum_pages_blocks_revista_block_block_title_size" DEFAULT 'medium',
  	"block_title_text_color" varchar DEFAULT '#2970B7',
  	"block_title_underline_color" varchar DEFAULT '#EFBA06',
  	"block_name" varchar
  );
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_grid_blogs" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"override_defaults" boolean DEFAULT false,
  	"block_title_title_text" varchar,
  	"block_title_tag" "enum_pages_blocks_grid_blogs_block_title_tag" DEFAULT 'h2',
  	"block_title_size" "enum_pages_blocks_grid_blogs_block_title_size" DEFAULT 'medium',
  	"block_title_text_color" varchar DEFAULT '#2970B7',
  	"block_title_underline_color" varchar DEFAULT '#EFBA06',
  	"general_style" "enum_pages_blocks_grid_blogs_general_style" DEFAULT 'grid',
  	"grid_style" boolean DEFAULT true,
  	"populate_by" "enum_pages_blocks_grid_blogs_populate_by" DEFAULT 'collection',
  	"limit" numeric DEFAULT 3,
  	"block_name" varchar
  );
  
  CREATE TABLE IF NOT EXISTS "pages_blocks_grid_paquetes" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"override_defaults" boolean DEFAULT false,
  	"block_title_title_text" varchar,
  	"block_title_tag" "enum_pages_blocks_grid_paquetes_block_title_tag" DEFAULT 'h2',
  	"block_title_size" "enum_pages_blocks_grid_paquetes_block_title_size" DEFAULT 'medium',
  	"block_title_text_color" varchar DEFAULT '#2970B7',
  	"block_title_underline_color" varchar DEFAULT '#EFBA06',
  	"grid_columns" numeric DEFAULT 6,
  	"grid_style" boolean DEFAULT true,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_ofertas" (
  	...
  	"title_text_color" varchar DEFAULT '#2970B7',
  	"title_underline_color" varchar DEFAULT '#EFBA06',
  	"type_grid" "enum__pages_v_blocks_ofertas_type_grid" DEFAULT 'grid',
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_form_bitrix_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_revista_block_revistas_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"image_id" integer,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_revista_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"block_title_title_text" varchar,
  	"block_title_tag" "enum__pages_v_blocks_revista_block_block_title_tag" DEFAULT 'h2',
  	"block_title_size" "enum__pages_v_blocks_revista_block_block_title_size" DEFAULT 'medium',
  	"block_title_text_color" varchar DEFAULT '#2970B7',
  	"block_title_underline_color" varchar DEFAULT '#EFBA06',
  	"_uuid" varchar,
  	"block_name" varchar
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_grid_blogs" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"override_defaults" boolean DEFAULT false,
  	"block_title_title_text" varchar,
  	"block_title_tag" "enum__pages_v_blocks_grid_blogs_block_title_tag" DEFAULT 'h2',
  	"block_title_size" "enum__pages_v_blocks_grid_blogs_block_title_size" DEFAULT 'medium',
  	"block_title_text_color" varchar DEFAULT '#2970B7',
  	"block_title_underline_color" varchar DEFAULT '#EFBA06',
  	"general_style" "enum__pages_v_blocks_grid_blogs_general_style" DEFAULT 'grid',
  	"grid_style" boolean DEFAULT true,
  	"populate_by" "enum__pages_v_blocks_grid_blogs_populate_by" DEFAULT 'collection',
  	"limit" numeric DEFAULT 3,
  	"_uuid" varchar,
  	"block_name" varchar
  );
  
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_grid_paquetes" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"override_defaults" boolean DEFAULT false,
  	"block_title_title_text" varchar,
  	"block_title_tag" "enum__pages_v_blocks_grid_paquetes_block_title_tag" DEFAULT 'h2',
  	"block_title_size" "enum__pages_v_blocks_grid_paquetes_block_title_size" DEFAULT 'medium',
  	"block_title_text_color" varchar DEFAULT '#2970B7',
  	"block_title_underline_color" varchar DEFAULT '#EFBA06',
  	"grid_columns" numeric DEFAULT 6,
  	"grid_style" boolean DEFAULT true,
  ...
  CREATE TABLE IF NOT EXISTS "tours_blocks_grid_blogs" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"override_defaults" boolean DEFAULT false,
  	"block_title_title_text" varchar,
  	"block_title_tag" "enum_tours_blocks_grid_blogs_block_title_tag" DEFAULT 'h2',
  	"block_title_size" "enum_tours_blocks_grid_blogs_block_title_size" DEFAULT 'medium',
  	"block_title_text_color" varchar DEFAULT '#2970B7',
  	"block_title_underline_color" varchar DEFAULT '#EFBA06',
  	"general_style" "enum_tours_blocks_grid_blogs_general_style" DEFAULT 'grid',
  	"grid_style" boolean DEFAULT true,
  	"populate_by" "enum_tours_blocks_grid_blogs_populate_by" DEFAULT 'collection',
  	"limit" numeric DEFAULT 3,
  	"block_name" varchar
  );
  ...
  CREATE TABLE IF NOT EXISTS "tours_blocks_form_bitrix_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "tours_blocks_revista_block_revistas_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"image_id" integer,
  ...
  CREATE TABLE IF NOT EXISTS "tours_blocks_revista_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"block_title_title_text" varchar,
  	"block_title_tag" "enum_tours_blocks_revista_block_block_title_tag" DEFAULT 'h2',
  	"block_title_size" "enum_tours_blocks_revista_block_block_title_size" DEFAULT 'medium',
  	"block_title_text_color" varchar DEFAULT '#2970B7',
  	"block_title_underline_color" varchar DEFAULT '#EFBA06',
  	"block_name" varchar
  );
  ...
  CREATE TABLE IF NOT EXISTS "_tours_v_blocks_grid_blogs" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"override_defaults" boolean DEFAULT false,
  	"block_title_title_text" varchar,
  	"block_title_tag" "enum__tours_v_blocks_grid_blogs_block_title_tag" DEFAULT 'h2',
  	"block_title_size" "enum__tours_v_blocks_grid_blogs_block_title_size" DEFAULT 'medium',
  	"block_title_text_color" varchar DEFAULT '#2970B7',
  	"block_title_underline_color" varchar DEFAULT '#EFBA06',
  	"general_style" "enum__tours_v_blocks_grid_blogs_general_style" DEFAULT 'grid',
  	"grid_style" boolean DEFAULT true,
  	"populate_by" "enum__tours_v_blocks_grid_blogs_populate_by" DEFAULT 'collection',
  	"limit" numeric DEFAULT 3,
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE IF NOT EXISTS "_tours_v_blocks_form_bitrix_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "_tours_v_blocks_revista_block_revistas_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"image_id" integer,
  ...
  CREATE TABLE IF NOT EXISTS "_tours_v_blocks_revista_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"block_title_title_text" varchar,
  	"block_title_tag" "enum__tours_v_blocks_revista_block_block_title_tag" DEFAULT 'h2',
  	"block_title_size" "enum__tours_v_blocks_revista_block_block_title_size" DEFAULT 'medium',
  	"block_title_text_color" varchar DEFAULT '#2970B7',
  	"block_title_underline_color" varchar DEFAULT '#EFBA06',
  	"_uuid" varchar,
  	"block_name" varchar
  ...
  CREATE TABLE IF NOT EXISTS "ofertas" (
  	...
  	"persona" varchar DEFAULT 'por persona' NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "posts_blocks_banner" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "posts_blocks_grid_blogs" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"override_defaults" boolean DEFAULT false,
  	"block_title_title_text" varchar,
  	"block_title_tag" "enum_posts_blocks_grid_blogs_block_title_tag" DEFAULT 'h2',
  	"block_title_size" "enum_posts_blocks_grid_blogs_block_title_size" DEFAULT 'medium',
  	"block_title_text_color" varchar DEFAULT '#2970B7',
  	"block_title_underline_color" varchar DEFAULT '#EFBA06',
  	"general_style" "enum_posts_blocks_grid_blogs_general_style" DEFAULT 'grid',
  	"grid_style" boolean DEFAULT true,
  	"populate_by" "enum_posts_blocks_grid_blogs_populate_by" DEFAULT 'collection',
  	"limit" numeric DEFAULT 3,
  	"block_name" varchar
  );
  
  CREATE TABLE IF NOT EXISTS "posts_blocks_grid_images_image" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"image_id" integer
  ...
  CREATE TABLE IF NOT EXISTS "posts_blocks_grid_images" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"type_grid" "enum_posts_blocks_grid_images_type_grid" DEFAULT 'grid',
  	"block_name" varchar
  );
  
  CREATE TABLE IF NOT EXISTS "posts_blocks_text_content" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"block_title_title_text" varchar,
  	"block_title_tag" "enum_posts_blocks_text_content_block_title_tag" DEFAULT 'h2',
  	"block_title_size" "enum_posts_blocks_text_content_block_title_size" DEFAULT 'medium',
  	"block_title_text_color" varchar DEFAULT '#2970B7',
  	"block_title_underline_color" varchar DEFAULT '#EFBA06',
  	"description" jsonb,
  	"description_alignment" "enum_posts_blocks_text_content_description_alignment" DEFAULT 'left',
  	"block_name" varchar
  );
  
  CREATE TABLE IF NOT EXISTS "posts_blocks_you_tube_links_video_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"image_id" integer,
  ...
  CREATE TABLE IF NOT EXISTS "posts_blocks_you_tube_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"block_title_title_text" varchar,
  	"block_title_tag" "enum_posts_blocks_you_tube_links_block_title_tag" DEFAULT 'h2',
  	"block_title_size" "enum_posts_blocks_you_tube_links_block_title_size" DEFAULT 'medium',
  	"block_title_text_color" varchar DEFAULT '#2970B7',
  	"block_title_underline_color" varchar DEFAULT '#EFBA06',
  	"block_name" varchar
  );
  ...
  CREATE TABLE IF NOT EXISTS "_posts_v_blocks_banner" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "_posts_v_blocks_grid_blogs" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"override_defaults" boolean DEFAULT false,
  	"block_title_title_text" varchar,
  	"block_title_tag" "enum__posts_v_blocks_grid_blogs_block_title_tag" DEFAULT 'h2',
  	"block_title_size" "enum__posts_v_blocks_grid_blogs_block_title_size" DEFAULT 'medium',
  	"block_title_text_color" varchar DEFAULT '#2970B7',
  	"block_title_underline_color" varchar DEFAULT '#EFBA06',
  	"general_style" "enum__posts_v_blocks_grid_blogs_general_style" DEFAULT 'grid',
  	"grid_style" boolean DEFAULT true,
  	"populate_by" "enum__posts_v_blocks_grid_blogs_populate_by" DEFAULT 'collection',
  	"limit" numeric DEFAULT 3,
  	"_uuid" varchar,
  	"block_name" varchar
  );
  
  CREATE TABLE IF NOT EXISTS "_posts_v_blocks_grid_images_image" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"image_id" integer,
  ...
  CREATE TABLE IF NOT EXISTS "_posts_v_blocks_grid_images" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"type_grid" "enum__posts_v_blocks_grid_images_type_grid" DEFAULT 'grid',
  	"_uuid" varchar,
  	"block_name" varchar
  );
  
  CREATE TABLE IF NOT EXISTS "_posts_v_blocks_text_content" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"block_title_title_text" varchar,
  	"block_title_tag" "enum__posts_v_blocks_text_content_block_title_tag" DEFAULT 'h2',
  	"block_title_size" "enum__posts_v_blocks_text_content_block_title_size" DEFAULT 'medium',
  	"block_title_text_color" varchar DEFAULT '#2970B7',
  	"block_title_underline_color" varchar DEFAULT '#EFBA06',
  	"description" jsonb,
  	"description_alignment" "enum__posts_v_blocks_text_content_description_alignment" DEFAULT 'left',
  	"_uuid" varchar,
  	"block_name" varchar
  );
  
  CREATE TABLE IF NOT EXISTS "_posts_v_blocks_you_tube_links_video_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"image_id" integer,
  ...
  CREATE TABLE IF NOT EXISTS "_posts_v_blocks_you_tube_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"block_title_title_text" varchar,
  	"block_title_tag" "enum__posts_v_blocks_you_tube_links_block_title_tag" DEFAULT 'h2',
  	"block_title_size" "enum__posts_v_blocks_you_tube_links_block_title_size" DEFAULT 'medium',
  	"block_title_text_color" varchar DEFAULT '#2970B7',
  	"block_title_underline_color" varchar DEFAULT '#EFBA06',
  	"_uuid" varchar,
  	"block_name" varchar
  ...
  CREATE TABLE IF NOT EXISTS "paquetes_blocks_grid_blogs" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"override_defaults" boolean DEFAULT false,
  	"block_title_title_text" varchar,
  	"block_title_tag" "enum_paquetes_blocks_grid_blogs_block_title_tag" DEFAULT 'h2',
  	"block_title_size" "enum_paquetes_blocks_grid_blogs_block_title_size" DEFAULT 'medium',
  	"block_title_text_color" varchar DEFAULT '#2970B7',
  	"block_title_underline_color" varchar DEFAULT '#EFBA06',
  	"general_style" "enum_paquetes_blocks_grid_blogs_general_style" DEFAULT 'grid',
  	"grid_style" boolean DEFAULT true,
  	"populate_by" "enum_paquetes_blocks_grid_blogs_populate_by" DEFAULT 'collection',
  	"limit" numeric DEFAULT 3,
  	"block_name" varchar
  );
  ...
  CREATE TABLE IF NOT EXISTS "paquetes_blocks_text_content" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"block_title_title_text" varchar,
  	"block_title_tag" "enum_paquetes_blocks_text_content_block_title_tag" DEFAULT 'h2',
  	"block_title_size" "enum_paquetes_blocks_text_content_block_title_size" DEFAULT 'medium',
  	"block_title_text_color" varchar DEFAULT '#2970B7',
  	"block_title_underline_color" varchar DEFAULT '#EFBA06',
  	"description" jsonb,
  	"description_alignment" "enum_paquetes_blocks_text_content_description_alignment" DEFAULT 'left',
  	"block_name" varchar
  );
  ...
  CREATE TABLE IF NOT EXISTS "paquetes_blocks_form_bitrix_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "paquetes_blocks_revista_block_revistas_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"image_id" integer,
  ...
  CREATE TABLE IF NOT EXISTS "paquetes_blocks_revista_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"block_title_title_text" varchar,
  	"block_title_tag" "enum_paquetes_blocks_revista_block_block_title_tag" DEFAULT 'h2',
  	"block_title_size" "enum_paquetes_blocks_revista_block_block_title_size" DEFAULT 'medium',
  	"block_title_text_color" varchar DEFAULT '#2970B7',
  	"block_title_underline_color" varchar DEFAULT '#EFBA06',
  	"block_name" varchar
  );
  ...
  CREATE TABLE IF NOT EXISTS "_paquetes_v_blocks_grid_blogs" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"override_defaults" boolean DEFAULT false,
  	"block_title_title_text" varchar,
  	"block_title_tag" "enum__paquetes_v_blocks_grid_blogs_block_title_tag" DEFAULT 'h2',
  	"block_title_size" "enum__paquetes_v_blocks_grid_blogs_block_title_size" DEFAULT 'medium',
  	"block_title_text_color" varchar DEFAULT '#2970B7',
  	"block_title_underline_color" varchar DEFAULT '#EFBA06',
  	"general_style" "enum__paquetes_v_blocks_grid_blogs_general_style" DEFAULT 'grid',
  	"grid_style" boolean DEFAULT true,
  	"populate_by" "enum__paquetes_v_blocks_grid_blogs_populate_by" DEFAULT 'collection',
  	"limit" numeric DEFAULT 3,
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE IF NOT EXISTS "_paquetes_v_blocks_text_content" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"block_title_title_text" varchar,
  	"block_title_tag" "enum__paquetes_v_blocks_text_content_block_title_tag" DEFAULT 'h2',
  	"block_title_size" "enum__paquetes_v_blocks_text_content_block_title_size" DEFAULT 'medium',
  	"block_title_text_color" varchar DEFAULT '#2970B7',
  	"block_title_underline_color" varchar DEFAULT '#EFBA06',
  	"description" jsonb,
  	"description_alignment" "enum__paquetes_v_blocks_text_content_description_alignment" DEFAULT 'left',
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE IF NOT EXISTS "_paquetes_v_blocks_form_bitrix_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "_paquetes_v_blocks_revista_block_revistas_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"image_id" integer,
  ...
  CREATE TABLE IF NOT EXISTS "_paquetes_v_blocks_revista_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"block_title_title_text" varchar,
  	"block_title_tag" "enum__paquetes_v_blocks_revista_block_block_title_tag" DEFAULT 'h2',
  	"block_title_size" "enum__paquetes_v_blocks_revista_block_block_title_size" DEFAULT 'medium',
  	"block_title_text_color" varchar DEFAULT '#2970B7',
  	"block_title_underline_color" varchar DEFAULT '#EFBA06',
  	"_uuid" varchar,
  	"block_name" varchar
  ...
  CREATE TABLE IF NOT EXISTS "reconocimientos_carousel_images" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "reconocimientos_carousel" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"updated_at" timestamp(3) with time zone,
  	"created_at" timestamp(3) with time zone
  );
  
  CREATE TABLE IF NOT EXISTS "socios_carousel_images" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"image_id" integer NOT NULL
  ...
  CREATE TABLE IF NOT EXISTS "socios_carousel" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"updated_at" timestamp(3) with time zone,
  	"created_at" timestamp(3) with time zone
  );
  
  CREATE TABLE IF NOT EXISTS "footer_nav_items_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_form_bitrix_block" ADD CONSTRAINT "pages_blocks_form_bitrix_block_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_revista_block" ADD CONSTRAINT "pages_blocks_revista_block_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_grid_blogs" ADD CONSTRAINT "pages_blocks_grid_blogs_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_form_bitrix_block" ADD CONSTRAINT "_pages_v_blocks_form_bitrix_block_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_revista_block" ADD CONSTRAINT "_pages_v_blocks_revista_block_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_grid_blogs" ADD CONSTRAINT "_pages_v_blocks_grid_blogs_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_grid_paquetes" ADD CONSTRAINT "_pages_v_blocks_grid_paquetes_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "tours_blocks_grid_blogs" ADD CONSTRAINT "tours_blocks_grid_blogs_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."tours"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "tours_blocks_revista_block_revistas_links" ADD CONSTRAINT "tours_blocks_revista_block_revistas_links_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."tours_blocks_revista_block"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "tours_blocks_revista_block" ADD CONSTRAINT "tours_blocks_revista_block_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."tours"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "tours_rels" ADD CONSTRAINT "tours_rels_blog_categories_fk" FOREIGN KEY ("blog_categories_id") REFERENCES "public"."blog_categories"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_tours_v_blocks_grid_blogs" ADD CONSTRAINT "_tours_v_blocks_grid_blogs_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_tours_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_tours_v_blocks_revista_block_revistas_links" ADD CONSTRAINT "_tours_v_blocks_revista_block_revistas_links_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_tours_v_blocks_revista_block"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_tours_v_blocks_revista_block" ADD CONSTRAINT "_tours_v_blocks_revista_block_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_tours_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_tours_v_rels" ADD CONSTRAINT "_tours_v_rels_blog_categories_fk" FOREIGN KEY ("blog_categories_id") REFERENCES "public"."blog_categories"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "posts_blocks_banner" ADD CONSTRAINT "posts_blocks_banner_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "posts_blocks_grid_blogs" ADD CONSTRAINT "posts_blocks_grid_blogs_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."posts"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "posts_blocks_grid_images_image" ADD CONSTRAINT "posts_blocks_grid_images_image_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "posts_blocks_grid_images_image" ADD CONSTRAINT "posts_blocks_grid_images_image_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."posts_blocks_grid_images"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "posts_blocks_grid_images" ADD CONSTRAINT "posts_blocks_grid_images_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."posts"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "posts_blocks_text_content" ADD CONSTRAINT "posts_blocks_text_content_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."posts"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "posts_blocks_you_tube_links" ADD CONSTRAINT "posts_blocks_you_tube_links_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."posts"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_posts_v_blocks_banner" ADD CONSTRAINT "_posts_v_blocks_banner_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_posts_v_blocks_grid_blogs" ADD CONSTRAINT "_posts_v_blocks_grid_blogs_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_posts_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_posts_v_blocks_grid_images_image" ADD CONSTRAINT "_posts_v_blocks_grid_images_image_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_posts_v_blocks_grid_images_image" ADD CONSTRAINT "_posts_v_blocks_grid_images_image_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_posts_v_blocks_grid_images"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_posts_v_blocks_grid_images" ADD CONSTRAINT "_posts_v_blocks_grid_images_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_posts_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_posts_v_blocks_you_tube_links_video_links" ADD CONSTRAINT "_posts_v_blocks_you_tube_links_video_links_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_posts_v_blocks_you_tube_links"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_posts_v_blocks_you_tube_links" ADD CONSTRAINT "_posts_v_blocks_you_tube_links_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_posts_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "paquetes_blocks_grid_blogs" ADD CONSTRAINT "paquetes_blocks_grid_blogs_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."paquetes"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "paquetes_blocks_text_content" ADD CONSTRAINT "paquetes_blocks_text_content_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."paquetes"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "paquetes_blocks_revista_block_revistas_links" ADD CONSTRAINT "paquetes_blocks_revista_block_revistas_links_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."paquetes_blocks_revista_block"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "paquetes_blocks_revista_block" ADD CONSTRAINT "paquetes_blocks_revista_block_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."paquetes"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "paquetes_rels" ADD CONSTRAINT "paquetes_rels_blog_categories_fk" FOREIGN KEY ("blog_categories_id") REFERENCES "public"."blog_categories"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_paquetes_v_blocks_grid_blogs" ADD CONSTRAINT "_paquetes_v_blocks_grid_blogs_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_paquetes_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_paquetes_v_blocks_text_content" ADD CONSTRAINT "_paquetes_v_blocks_text_content_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_paquetes_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_paquetes_v_blocks_revista_block_revistas_links" ADD CONSTRAINT "_paquetes_v_blocks_revista_block_revistas_links_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_paquetes_v_blocks_revista_block"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_paquetes_v_blocks_revista_block" ADD CONSTRAINT "_paquetes_v_blocks_revista_block_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_paquetes_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_paquetes_v_rels" ADD CONSTRAINT "_paquetes_v_rels_blog_categories_fk" FOREIGN KEY ("blog_categories_id") REFERENCES "public"."blog_categories"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "reconocimientos_carousel_images" ADD CONSTRAINT "reconocimientos_carousel_images_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "reconocimientos_carousel_images" ADD CONSTRAINT "reconocimientos_carousel_images_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."reconocimientos_carousel"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "socios_carousel_images" ADD CONSTRAINT "socios_carousel_images_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "socios_carousel_images" ADD CONSTRAINT "socios_carousel_images_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."socios_carousel"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "footer_rels" ADD CONSTRAINT "footer_rels_tours_fk" FOREIGN KEY ("tours_id") REFERENCES "public"."tours"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "footer_rels" ADD CONSTRAINT "footer_rels_paquetes_fk" FOREIGN KEY ("paquetes_id") REFERENCES "public"."paquetes"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "pages_blocks_form_bitrix_block_order_idx" ON "pages_blocks_form_bitrix_block" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_form_bitrix_block_parent_id_idx" ON "pages_blocks_form_bitrix_block" USING btree ("_parent_id");
  ...
  CREATE INDEX IF NOT EXISTS "pages_blocks_grid_blogs_order_idx" ON "pages_blocks_grid_blogs" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_grid_blogs_parent_id_idx" ON "pages_blocks_grid_blogs" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_grid_blogs_path_idx" ON "pages_blocks_grid_blogs" USING btree ("_path");
  ...
  CREATE INDEX IF NOT EXISTS "pages_rels_destinations_id_idx" ON "pages_rels" USING btree ("destinations_id");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_form_bitrix_block_order_idx" ON "_pages_v_blocks_form_bitrix_block" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_form_bitrix_block_parent_id_idx" ON "_pages_v_blocks_form_bitrix_block" USING btree ("_parent_id");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_grid_blogs_order_idx" ON "_pages_v_blocks_grid_blogs" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_grid_blogs_parent_id_idx" ON "_pages_v_blocks_grid_blogs" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_grid_blogs_path_idx" ON "_pages_v_blocks_grid_blogs" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_grid_paquetes_order_idx" ON "_pages_v_blocks_grid_paquetes" USING btree ("_order");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_rels_destinations_id_idx" ON "_pages_v_rels" USING btree ("destinations_id");
  ...
  CREATE INDEX IF NOT EXISTS "tours_rels_blog_categories_id_idx" ON "tours_rels" USING btree ("blog_categories_id");
  ...
  CREATE INDEX IF NOT EXISTS "_tours_v_rels_blog_categories_id_idx" ON "_tours_v_rels" USING btree ("blog_categories_id");
  ...
  CREATE INDEX IF NOT EXISTS "posts_blocks_banner_order_idx" ON "posts_blocks_banner" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "posts_blocks_banner_parent_id_idx" ON "posts_blocks_banner" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "posts_blocks_banner_path_idx" ON "posts_blocks_banner" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "posts_blocks_banner_image_idx" ON "posts_blocks_banner" USING btree ("image_id");
  ...
  CREATE INDEX IF NOT EXISTS "posts_blocks_grid_blogs_order_idx" ON "posts_blocks_grid_blogs" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "posts_blocks_grid_blogs_parent_id_idx" ON "posts_blocks_grid_blogs" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "posts_blocks_grid_blogs_path_idx" ON "posts_blocks_grid_blogs" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "posts_blocks_grid_images_image_order_idx" ON "posts_blocks_grid_images_image" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "posts_blocks_grid_images_image_parent_id_idx" ON "posts_blocks_grid_images_image" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "posts_blocks_grid_images_image_image_idx" ON "posts_blocks_grid_images_image" USING btree ("image_id");
  CREATE INDEX IF NOT EXISTS "posts_blocks_grid_images_order_idx" ON "posts_blocks_grid_images" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "posts_blocks_grid_images_parent_id_idx" ON "posts_blocks_grid_images" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "posts_blocks_grid_images_path_idx" ON "posts_blocks_grid_images" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "posts_blocks_text_content_order_idx" ON "posts_blocks_text_content" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "posts_blocks_text_content_parent_id_idx" ON "posts_blocks_text_content" USING btree ("_parent_id");
  ...
  CREATE INDEX IF NOT EXISTS "_posts_v_blocks_banner_order_idx" ON "_posts_v_blocks_banner" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_posts_v_blocks_banner_parent_id_idx" ON "_posts_v_blocks_banner" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_posts_v_blocks_banner_path_idx" ON "_posts_v_blocks_banner" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "_posts_v_blocks_banner_image_idx" ON "_posts_v_blocks_banner" USING btree ("image_id");
  ...
  CREATE INDEX IF NOT EXISTS "_posts_v_blocks_grid_blogs_order_idx" ON "_posts_v_blocks_grid_blogs" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_posts_v_blocks_grid_blogs_parent_id_idx" ON "_posts_v_blocks_grid_blogs" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_posts_v_blocks_grid_blogs_path_idx" ON "_posts_v_blocks_grid_blogs" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "_posts_v_blocks_grid_images_image_order_idx" ON "_posts_v_blocks_grid_images_image" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_posts_v_blocks_grid_images_image_parent_id_idx" ON "_posts_v_blocks_grid_images_image" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_posts_v_blocks_grid_images_image_image_idx" ON "_posts_v_blocks_grid_images_image" USING btree ("image_id");
  CREATE INDEX IF NOT EXISTS "_posts_v_blocks_grid_images_order_idx" ON "_posts_v_blocks_grid_images" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_posts_v_blocks_grid_images_parent_id_idx" ON "_posts_v_blocks_grid_images" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_posts_v_blocks_grid_images_path_idx" ON "_posts_v_blocks_grid_images" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "_posts_v_blocks_text_content_order_idx" ON "_posts_v_blocks_text_content" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_posts_v_blocks_text_content_parent_id_idx" ON "_posts_v_blocks_text_content" USING btree ("_parent_id");
  ...
  CREATE INDEX IF NOT EXISTS "paquetes_blocks_grid_blogs_order_idx" ON "paquetes_blocks_grid_blogs" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "paquetes_blocks_grid_blogs_parent_id_idx" ON "paquetes_blocks_grid_blogs" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "paquetes_blocks_grid_blogs_path_idx" ON "paquetes_blocks_grid_blogs" USING btree ("_path");
  ...
  CREATE INDEX IF NOT EXISTS "paquetes_blocks_text_content_order_idx" ON "paquetes_blocks_text_content" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "paquetes_blocks_text_content_parent_id_idx" ON "paquetes_blocks_text_content" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "paquetes_blocks_text_content_path_idx" ON "paquetes_blocks_text_content" USING btree ("_path");
  ...
  CREATE INDEX IF NOT EXISTS "paquetes_blocks_form_bitrix_block_order_idx" ON "paquetes_blocks_form_bitrix_block" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "paquetes_blocks_form_bitrix_block_parent_id_idx" ON "paquetes_blocks_form_bitrix_block" USING btree ("_parent_id");
  ...
  CREATE INDEX IF NOT EXISTS "paquetes_rels_blog_categories_id_idx" ON "paquetes_rels" USING btree ("blog_categories_id");
  ...
  CREATE INDEX IF NOT EXISTS "_paquetes_v_blocks_grid_blogs_order_idx" ON "_paquetes_v_blocks_grid_blogs" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_paquetes_v_blocks_grid_blogs_parent_id_idx" ON "_paquetes_v_blocks_grid_blogs" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_paquetes_v_blocks_grid_blogs_path_idx" ON "_paquetes_v_blocks_grid_blogs" USING btree ("_path");
  ...
  CREATE INDEX IF NOT EXISTS "_paquetes_v_blocks_text_content_order_idx" ON "_paquetes_v_blocks_text_content" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_paquetes_v_blocks_text_content_parent_id_idx" ON "_paquetes_v_blocks_text_content" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_paquetes_v_blocks_text_content_path_idx" ON "_paquetes_v_blocks_text_content" USING btree ("_path");
  ...
  CREATE INDEX IF NOT EXISTS "_paquetes_v_blocks_form_bitrix_block_order_idx" ON "_paquetes_v_blocks_form_bitrix_block" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_paquetes_v_blocks_form_bitrix_block_parent_id_idx" ON "_paquetes_v_blocks_form_bitrix_block" USING btree ("_parent_id");
  ...
  CREATE INDEX IF NOT EXISTS "_paquetes_v_rels_blog_categories_id_idx" ON "_paquetes_v_rels" USING btree ("blog_categories_id");
  ...
  CREATE INDEX IF NOT EXISTS "reconocimientos_carousel_images_order_idx" ON "reconocimientos_carousel_images" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "reconocimientos_carousel_images_parent_id_idx" ON "reconocimientos_carousel_images" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "reconocimientos_carousel_images_image_idx" ON "reconocimientos_carousel_images" USING btree ("image_id");
  CREATE INDEX IF NOT EXISTS "socios_carousel_images_order_idx" ON "socios_carousel_images" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "socios_carousel_images_parent_id_idx" ON "socios_carousel_images" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "socios_carousel_images_image_idx" ON "socios_carousel_images" USING btree ("image_id");
  CREATE INDEX IF NOT EXISTS "footer_nav_items_links_order_idx" ON "footer_nav_items_links" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "footer_nav_items_links_parent_id_idx" ON "footer_nav_items_links" USING btree ("_parent_id");
  ...
  CREATE INDEX IF NOT EXISTS "footer_rels_tours_id_idx" ON "footer_rels" USING btree ("tours_id");
  CREATE INDEX IF NOT EXISTS "footer_rels_paquetes_id_idx" ON "footer_rels" USING btree ("paquetes_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "pages_blocks_form_bitrix_block" CASCADE;
  DROP TABLE "pages_blocks_revista_block_revistas_links" CASCADE;
  DROP TABLE "pages_blocks_revista_block" CASCADE;
  DROP TABLE "pages_blocks_row_block_columns" CASCADE;
  DROP TABLE "pages_blocks_row_block" CASCADE;
  DROP TABLE "pages_blocks_grid_blogs" CASCADE;
  DROP TABLE "pages_blocks_grid_paquetes" CASCADE;
  ...
  DROP TABLE "_pages_v_blocks_form_bitrix_block" CASCADE;
  DROP TABLE "_pages_v_blocks_revista_block_revistas_links" CASCADE;
  DROP TABLE "_pages_v_blocks_revista_block" CASCADE;
  DROP TABLE "_pages_v_blocks_row_block_columns" CASCADE;
  DROP TABLE "_pages_v_blocks_row_block" CASCADE;
  DROP TABLE "_pages_v_blocks_grid_blogs" CASCADE;
  DROP TABLE "_pages_v_blocks_grid_paquetes" CASCADE;
  ...
  DROP TABLE "posts_blocks_grid_blogs" CASCADE;
  DROP TABLE "posts_blocks_grid_images_image" CASCADE;
  DROP TABLE "posts_blocks_grid_images" CASCADE;
  DROP TABLE "posts_blocks_text_content" CASCADE;
  DROP TABLE "posts_blocks_you_tube_links_video_links" CASCADE;
  DROP TABLE "posts_blocks_you_tube_links" CASCADE;
  ...
  DROP TABLE "_posts_v_blocks_grid_blogs" CASCADE;
  DROP TABLE "_posts_v_blocks_grid_images_image" CASCADE;
  DROP TABLE "_posts_v_blocks_grid_images" CASCADE;
  DROP TABLE "_posts_v_blocks_text_content" CASCADE;
  DROP TABLE "_posts_v_blocks_you_tube_links_video_links" CASCADE;
  DROP TABLE "_posts_v_blocks_you_tube_links" CASCADE;
  ...
  DROP TABLE "paquetes_blocks_grid_blogs" CASCADE;
  ...
  DROP TABLE "paquetes_blocks_text_content" CASCADE;
  DROP TABLE "paquetes_blocks_socios" CASCADE;
  DROP TABLE "paquetes_blocks_reconocimientos" CASCADE;
  DROP TABLE "paquetes_blocks_form_bitrix_block" CASCADE;
  DROP TABLE "paquetes_blocks_revista_block_revistas_links" CASCADE;
  DROP TABLE "paquetes_blocks_revista_block" CASCADE;
  ...
  DROP TABLE "_paquetes_v_blocks_grid_blogs" CASCADE;
  ...
  DROP TABLE "_paquetes_v_blocks_text_content" CASCADE;
  DROP TABLE "_paquetes_v_blocks_socios" CASCADE;
  DROP TABLE "_paquetes_v_blocks_reconocimientos" CASCADE;
  DROP TABLE "_paquetes_v_blocks_form_bitrix_block" CASCADE;
  DROP TABLE "_paquetes_v_blocks_revista_block_revistas_links" CASCADE;
  DROP TABLE "_paquetes_v_blocks_revista_block" CASCADE;
  ...
  DROP TABLE "reconocimientos_carousel_images" CASCADE;
  DROP TABLE "reconocimientos_carousel" CASCADE;
  DROP TABLE "socios_carousel_images" CASCADE;
  DROP TABLE "socios_carousel" CASCADE;
  ...
  DROP TYPE "public"."enum_pages_blocks_ofertas_type_grid";
  ...
  DROP TYPE "public"."enum_pages_blocks_grid_blogs_general_style";
  DROP TYPE "public"."enum_pages_blocks_grid_blogs_populate_by";
  ...
  DROP TYPE "public"."enum__pages_v_blocks_ofertas_type_grid";
  ...
  DROP TYPE "public"."enum__pages_v_blocks_grid_blogs_general_style";
  DROP TYPE "public"."enum__pages_v_blocks_grid_blogs_populate_by";
  ...
  DROP TYPE "public"."enum_tours_blocks_grid_blogs_general_style";
  ...
  DROP TYPE "public"."enum__tours_v_blocks_grid_blogs_general_style";
  ...
  DROP TYPE "public"."enum_posts_blocks_grid_blogs_general_style";
  DROP TYPE "public"."enum_posts_blocks_grid_blogs_populate_by";
  DROP TYPE "public"."enum_posts_blocks_grid_images_type_grid";
  ...
  DROP TYPE "public"."enum_posts_blocks_text_content_description_alignment";
  ...
  DROP TYPE "public"."enum__posts_v_blocks_grid_blogs_general_style";
  DROP TYPE "public"."enum__posts_v_blocks_grid_blogs_populate_by";
  DROP TYPE "public"."enum__posts_v_blocks_grid_images_type_grid";
  ...
  DROP TYPE "public"."enum__posts_v_blocks_text_content_description_alignment";
  ...
  DROP TYPE "public"."enum_paquetes_blocks_grid_blogs_general_style";
  DROP TYPE "public"."enum_paquetes_blocks_grid_blogs_populate_by";
  ...
  DROP TYPE "public"."enum_paquetes_blocks_text_content_description_alignment";
  ...
  DROP TYPE "public"."enum__paquetes_v_blocks_grid_blogs_general_style";
  DROP TYPE "public"."enum__paquetes_v_blocks_grid_blogs_populate_by";
  ...
  DROP TYPE "public"."enum__paquetes_v_blocks_text_content_description_alignment";
